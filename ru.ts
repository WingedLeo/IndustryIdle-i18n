export const RU = {
    ...
    Vancouver: "Ванкувер",
    VancouverBonus:
        "<li>Каждые 4 различные типа зданий дают 1 бесплатное разрешение на строительство</li><li>Уникальная политика: Диверсификация производства</li><li>Уникальное здание: Фабрика кленового сиропа</li><li>Бесплатный транспорт Кленового сиропа</li><li>Уникальный вид топлива: Кленовый сироп</li><li>2-х кратная торговая квота игрока при торговле ураном и обогащенным ураном</li><li>Уникальная бесплатная политика: Пластиковый сироп</li><li>Фабрики игрушек имеют 2Х производительность</li><li>Игровые студии имеют 2Х мощность</li>",
    ...
    BarbariansAtTheGateDesc: "Используйте торговую квоту игрока в 1 триллион между обновлениями рынка",
    ...
    GalvanicBatteryFactory: "Завод Гальванич. Аккумуляторов ",
    ...
    ImportGameDesc: "%{import} импорт(-а) за последние %{days} дней",
    ExportSaveWarning:
        "НЕ передавайте свой файл сохранения другим лицам (кроме разработчика) - файл сохранения содержит идентификаторы вашей учетной записи и позволит другим лицам завладеть вашей учетной записью",
    FontSizeScaling: "Масштабирование размера шрифта",
    FontSizeScalingDesc: "Измените масштаб размера шрифта пользовательского интерфейса. Некоторые элементы пользовательского интерфейса могут выглядеть не на своем месте. ТРЕБУЕТ ПЕРЕЗАГРУЗКИ",
    ...
    KansasCityBonus:
        "<li>Фермы и теплицы производят 2x кукурузы</li><li>Бесплатная перевозка кукурузы</li><li>За каждый уровень гидроплотины даётся 5% прибавка к прилегающим фермам</li><li>Каждые 2 фермы даётся 1 бесплатное разрешение на строительство</li><li>Политика Солнце никогда не заходит также заставляет фермы работать 100% времени (включая оффлайн)</li><li>2x к торговой квоте игрока при торговле сельскохозяйственными культурами</li><li>Разблокированы Пищевые заводы</li>",
    KansasCityHydroDamBoost: "Уникальный бонус Канзас-Сити: эта гидроплотина обеспечивает %{boost} прибавку к прилегающим фермерам",
    PerthGeothermalPowerPlantBoost:
        "Уникальный бонус г. Перт: эта геотермальная электростанция обеспечивает %{boost} ускорение смежных зданий, производящих сталь",
    PerthBonus:
