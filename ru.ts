export const RU = {
    ...
    ExtraTradeQuotaDesc:
        "Начальная квота на торговлю игроками составляет 1% от вашего рыночного капитала - это даст дополнительный процент",
    ...
    PlayerTradeQuotaPenaltyWarning:
        "Стоимость ваших продаж с этим игроком превышает 1% от вашей рыночной капитализации, и цена этой сделки слишком сильно отличается от вашей локальной цены. Для выполнения этой сделки требуется дополнительная торговая квота",
